        ...
        <div class="jumbotron box">
            <div class="row ver">
                <div class="col-sm-3 col-sm-left">
                    ...
                    <button class="btn btn-danger btn-inverse btn-sm btn-block"><span class="fa fa-info-circle"></span>Reportar error</button>
                    <button class="btn btn-primary btn-inverse btn-sm btn-block"><span class="fa fa-thumbs-o-up"></span>Me Gusta</button>
                </div>
                <div class="col-sm-9 col-sm-right">
                    ...
                    <div class="data"><span class="fa fa-thumbs-o-up"></span><?= $movie->p_votos ?></div>
